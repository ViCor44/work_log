                ...
                <div class="col-md-3 mb-4">
                    <div class="report-block">
                        ...
                        <table class="table table-bordered report-table">
                            ...
                            <tr><td>Dif. Cloro total-livre</td><td><?= print_chlorine_diff(isset($analysis_data['manha'][$tank['id']]['chlorine_total']) ? $analysis_data['manha'][$tank['id']]['chlorine_total'] : null, isset($analysis_data['manha'][$tank['id']]['chlorine_level']) ? $analysis_data['manha'][$tank['id']]['chlorine_level'] : null) ?></td></tr>
