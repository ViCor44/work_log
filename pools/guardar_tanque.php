...
if (isset($_POST['id']) && !empty($_POST['id'])) {
    ...
    $stmt = $conn->prepare("
        ...
        WHERE id = ?
    ");
    $stmt->bind_param("ssiiiiisii", $name, $type, $water_freq, $hypo, $analysis, $has_controller, $controller_ip, $has_reject_counter, $volume_m3, $tank_id);
} 
// Se estiver a criar um novo
    ...
    $stmt = $conn->prepare("
        ...
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
    ");
    $stmt->bind_param("ssiiiiisii", $name, $type, $water_freq, $hypo, $analysis, $has_controller, $controller_ip, $has_reject_counter, $volume_m3);
}
