    ...
    <div class="row justify-content-center">
        <div class="col-md-4 mb-4">
            <div class="card card-link text-center">
                <div class="card-body">
                    <h5 class="card-title"><i class="fas fa-brain"></i> Análise PID Inteligente</h5>
                    <p class="card-text">Análise automática de controle PID baseada em dados históricos.</p>
                    <a href="pools/dashboard.php" class="btn btn-success">Aceder Análise PID</a>
                </div>
            </div>
        </div>
        </div>
